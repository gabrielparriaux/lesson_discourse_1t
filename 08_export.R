...
if (discourse_to_other_teacher) {
  lesson_df <- data.frame(lesson_full_duration = lesson_full_duration,
                          lesson_disc_number_of_statements = first_teacher_disc_number_of_statements,
                          lesson_to_class_number_of_statements = first_teacher_disc_to_class_number_of_statements,
                          lesson_to_pupil_number_of_statements = first_teacher_disc_to_pupil_number_of_statements,
                          lesson_to_teacher_number_of_statements = first_teacher_disc_to_teacher_number_of_statements,
                          lesson_disc_text_length = first_teacher_disc_text_length,
                          lesson_to_class_text_length = first_teacher_disc_to_class_text_length,
                          lesson_to_pupil_text_length = first_teacher_disc_to_pupil_text_length,
                          lesson_to_teacher_text_length = first_teacher_disc_to_teacher_text_length,
                          lesson_disc_vocab_size = first_teacher_disc_vocab_size,
                          lesson_to_class_vocab_size = first_teacher_disc_to_class_vocab_size,
                          lesson_to_pupil_vocab_size = first_teacher_disc_to_pupil_vocab_size,
                          lesson_to_teacher_vocab_size = first_teacher_disc_to_teacher_vocab_size,
                          lesson_disc_duration = first_teacher_disc_duration,
                          lesson_to_class_duration = first_teacher_disc_to_class_duration,
                          lesson_to_pupil_duration = first_teacher_disc_to_pupil_duration,
                          lesson_to_teacher_duration = first_teacher_disc_to_teacher_duration,
                          lesson_disc_lexical_diversity = first_teacher_disc_lexical_diversity,
                          lesson_to_class_lexical_diversity = first_teacher_disc_to_class_lexical_diversity,
                          lesson_to_pupil_lexical_diversity = first_teacher_disc_to_pupil_lexical_diversity,
                          lesson_to_teacher_lexical_diversity = first_teacher_disc_to_teacher_lexical_diversity,
  ...
  lesson_df <- data.frame(lesson_full_duration = lesson_full_duration,
                          ...
                          lesson_to_class_number_of_statements = first_teacher_disc_to_class_number_of_statements,
                          lesson_to_pupil_number_of_statements = first_teacher_disc_to_pupil_number_of_statements,
                          lesson_to_teacher_number_of_statements = NA,
                          lesson_disc_text_length = first_teacher_disc_text_length,
                          lesson_to_class_text_length = first_teacher_disc_to_class_text_length,
                          lesson_to_pupil_text_length = first_teacher_disc_to_pupil_text_length,
                          lesson_to_teacher_text_length = NA,
                          lesson_disc_vocab_size = first_teacher_disc_vocab_size,
                          lesson_to_class_vocab_size = first_teacher_disc_to_class_vocab_size,
                          lesson_to_pupil_vocab_size = first_teacher_disc_to_pupil_vocab_size,
                          lesson_to_teacher_vocab_size = NA,
                          lesson_disc_duration = first_teacher_disc_duration,
                          lesson_to_class_duration = first_teacher_disc_to_class_duration,
                          lesson_to_pupil_duration = first_teacher_disc_to_pupil_duration,
                          lesson_to_teacher_duration = NA,
                          lesson_disc_lexical_diversity = first_teacher_disc_lexical_diversity,
                          lesson_to_class_lexical_diversity = first_teacher_disc_to_class_lexical_diversity,
                          lesson_to_pupil_lexical_diversity = first_teacher_disc_to_pupil_lexical_diversity,
                          lesson_to_teacher_lexical_diversity = NA,
                          number_of_lesson_clusters = number_of_lesson_clusters
  )
}
...
discourses_df <- data.frame(discourses_first_teacher)
